...
void test4()
{
	relationSize = 450000;
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationForward With relationSize = 450000, This will split non-leaf node" << std::endl;
...
void test5()
{
	relationSize = 450000;
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationBackward With relationSize = 450000, This will split non-leaf node" << std::endl;
	std::cout << "LOADING..." << std::endl;
	createRelationBackward();
	indexTests();
	deleteRelation();
...
void test6()
{
	relationSize = 600000;
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationForward With relationSize = 600000, This will split non-leaf node" << std::endl;
	std::cout << "LOADING..." << std::endl;
	createRelationForward();
	largeIndexTests();
	deleteRelation();
...
void test7()
{
	relationSize = 600000;
	std::cout << "--------------------" << std::endl;
	std::cout << "createRelationBackward With relationSize = 600000, This will split non-leaf node" << std::endl;
	std::cout << "LOADING..." << std::endl;
	createRelationBackward();
	largeIndexTests();
	deleteRelation();
...
void intTests()
{
  ...
  BTreeIndex index(relationName, intIndexName, bufMgr, offsetof(tuple,i), INTEGER);
	...
	checkPassFail(intScan(&index,100,GT,1000,LTE), 900)
...
int intScan(BTreeIndex * index, int lowVal, Operator lowOp, int highVal, Operator highOp)
{
  ...
  int numResults = 0;
	...
	//SCHEN-Test
	std::cout<<"Start testing Scan"<<std::endl;
	}
